...
//set canvas to middle of screen
canvas.style.position = 'absolute';
// set canvas top to middle of screen
canvas.style.top = (window.innerHeight - canvas.height) / 2 - 180 + 'px';
...
function loop() {
    ...
    if(counterAlert > 30){
        let p = BOARD_DEF.move == PLAYER.P1 ? "white(you)" : "Black(AI)";
        stopLoop = true;
        alert(p +" wins!");
    }
    if(!stopLoop)
